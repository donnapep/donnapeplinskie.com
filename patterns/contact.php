 ...
 * Slug: donnapeplinskie/contact
 * Categories: donnapeplinskie
 * Description: Contact section with information and message area
 */
?>
...
<div id="contact" class="wp-block-group alignfull contact-section has-cyan-background-color has-background" style="padding-top:120px;padding-bottom:120px">
	...
	<div class="wp-block-columns animate-on-scroll stagger-children">
		...
		<div class="wp-block-column">
			<!-- wp:group {"className":"post-card","style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"}},"border":{"radius":"2px"}},"backgroundColor":"white","layout":{"type":"constrained"}} -->
			<div class="wp-block-group post-card has-white-background-color has-background" style="border-radius:2px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group post-card has-white-background-color has-background" style="border-radius:2px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
				<!-- wp:heading {"level":3,"style":{"typography":{"fontWeight":"500"},"spacing":{"margin":{"bottom":"20px"}}},"fontSize":"large"} -->
				<h3 class="wp-block-heading has-large-font-size" style="font-weight:500;margin-bottom:20px">Send a Message</h3>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"textColor":"gray"} -->
				<p class="has-gray-color has-text-color">Add a contact form here using a plugin like WPForms or Contact Form 7.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
